    ...
    <section class="content">
        <div class="row">
            <div class="col-md-1 col-xs-3 tabbed">
                <a href="{{route('consultant.borrowers')}}" class="tab-title">All</a>
            </div>
            <div class="col-md-2 col-xs-3  tabbed">
                <a href="{{route('consultant.borrowers.corporate')}}" class="tab-title">Corporate</a>
            </div>
            <div class="col-md-2 col-xs-3 tabbed tab-active">
                <a href="{{route('consultant.borrowers.blacklisted')}}" class="tab-title">Blacklist</a>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All Blacklisted Borrowers</h3>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        ...
                                        <a href="{{route('consultant.borrowers.details')}}" class="btn btn-default btn-sm">
                                            View detail
                                        </a>

...
@section('content')
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                "
                        ...
                        >
                            <div class="icon">
                                <img
                                    src="{{asset('web')}}/img/services/001-network.svg"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                ...
                "
                        ...
                        >
                            <div class="icon">
                                <img
                                    src="{{asset('web')}}/img/services/002-team.svg"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                ...
                "
                        ...
                        >
                            <div class="icon">
                                <img
                                    src="{{asset('web')}}/img/services/003-bullhorn.svg"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
                ...
                "
                        ...
                        >
                            <div class="icon">
                                <img
                                    src="{{asset('web')}}/img/services/004-project-management.svg"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
        ...
        {{--                    <div class="col-md-12">--}}
        {{--                        <div class="blog-img">--}}
        {{--                            <img src="{{asset('web')}}/img/blog.svg" alt="" class="img-fluid"/>--}}
        {{--                        </div>--}}
        {{--                    </div>--}}
        {{--                </div>--}}
        {{--            </div>--}}
                    ...
                    @if($blogs->count())
                        @foreach($blogs as $blog)
                            <div class="newletter-item overlay">
                                <div class="news-img">
                                    <img src="{{ $blog->featured_image?asset('storage').'/'.$blog->featured_image:asset('web/img/newsletter/portfolio-1.jpg')}}"
                                         alt=""

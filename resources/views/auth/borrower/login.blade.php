    ...
    <div class="position-relative d-flex flex-column justify-content-center">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <a href="{{route('borrower.forgot-password')}}" class="text-muted">Forgot Password?</a>
            ...
            >
              ...
              "
                >
                    <img src="{{asset('web')}}/img/google-sign-up.png" class="img-fluid" alt=""/>
                </button>
                <button
                    class="
                sing-btn
              ...
              "
                >
                    <img src="{{asset('web')}}/img/singpass.svg" class="img-fluid" alt=""/>
                </button>
            </div>
            <p>
                Don’t have an account?
                <a href="{{route('borrower.register')}}" class="text-muted">Register</a>
            </p>
        </form>
    </div>
</section>

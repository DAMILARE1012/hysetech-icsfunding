    ...
    <div class="position-relative d-flex flex-column justify-content-center">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input
                        ...
                        value="1"
                        {{old('appointed_director')==1?'checked':''}}
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input
                        ...
                        name="appointed_director"
                        value="0"
                        {{old('appointed_director',-1)==0?'checked':''}}
                        class="custom-control-input"
                    />
                ...
                @error('appointed_director')
                <br>
                <span class="text-danger text-sm pull-right">{{$errors->first('appointed_director')}}</span>
                @enderror
            </div>
            ...
            <p>
                ...
                <a href="{{route('borrower.login')}}" class="text-muted">Login</a>
            </p>
        </form>
    </div>
</section>

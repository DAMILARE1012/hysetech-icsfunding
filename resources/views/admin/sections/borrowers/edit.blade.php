                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="registration_type" name="registration_type"
                                                       class="form-control"
                                                       value="{{old('registration_type', $business->registration_type)}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="incorporation_type" id="incorporation_type"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="Private Limited Company" {{old('incorporation_type',$business->incorporation_type) == 'Private Limited Company'?'selected':''}}>
                                                        Private Limited Company
                                                    </option>
                                                    <option
                                                        value="Public Limited Company" {{old('incorporation_type',$business->incorporation_type) == 'Public Limited Company'?'selected':''}}>
                                                        Public Limited Company
                                                    </option>
                                                    <option
                                                        value="Public Company Limited by Guarantee" {{old('incorporation_type',$business->incorporation_type) == 'Public Company Limited by Guarantee'?'selected':''}}>
                                                        Public Company Limited by Guarantee
                                                    </option>
                                                    <option
                                                        value="Sole Proprietorship" {{old('incorporation_type',$business->incorporation_type) == 'Sole Proprietorship'?'selected':''}}>
                                                        Sole Proprietorship
                                                    </option>
                                                    <option
                                                        value="Partnership" {{old('incorporation_type',$business->incorporation_type) == 'Partnership'?'selected':''}}>
                                                        Partnership
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control select2"
                                                    ...
                                                    @foreach($countries as $index=>$country)
                                                        <option
                                                            value="{{$country}}" {{old('country', $business->country) == $country ?'selected':''}}>{{$country}}</option>
                                                    @endforeach
                                                </select>
                                                @error('country')
                                                <span
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="loan_limit" name="loan_limit"
                                                       class="form-control"
                                                       value="{{old('loan_limit',$business->loan_limit)}}"
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select name="industry_id" id="industry_id" class="form-control select2"
                                                    ...
                                                    @foreach($industries as $industry)
                                                        <option
                                                            value="{{$industry->id}}" {{old('industry_id', $business->industry_id) == $industry->id?'selected':''}}>{{$industry->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('industry_id')
                                                <span
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="sub_industry_id" id="sub_industry_id"
                                                    ...
                                                    @foreach($subIndustries as $subIndustry)
                                                        <option
                                                            value="{{$subIndustry->id}}" {{old('sub_industry_id', $business->sub_industry_id) == $subIndustry->id?'selected':''}}>{{$subIndustry->name}}</option>@endforeach
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="alternate_email" name="alternate_email"
                                                       class="form-control"
                                                       value="{{old('alternate_email', $business->alternate_email)}}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="office_phone" name="office_phone"
                                                       class="form-control"
                                                       value="{{old('office_phone', $business->office_phone)}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="hand_phone" name="hand_phone"
                                                       class="form-control"
                                                       value="{{old('hand_phone', $business->hand_phone)}}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="sms_phone" name="sms_phone"
                                                       class="form-control"
                                                       value="{{old('sms_phone', $business->sms_phone)}}"

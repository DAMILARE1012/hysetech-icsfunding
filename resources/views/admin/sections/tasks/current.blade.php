        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools pt-2">
                    ...
                    <div class="modal" id="modal-followup">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form
                                    action="{{ route('admin.tasks.add-followup') }}"
                                    method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <select name="application_id" id="application_id"
                                                ...
                                                @foreach($applications as $index=>$application)
                                                    <option
                                                        value="{{$application->id}}">{{$application->business->name}}{{$application->activeLoan->loanType?' - '.$application->activeLoan->loanType->title:''}}</option>
                                                @endforeach
                                            </select>
                                            @error('application_id')
                                            <span
                                                class="text-danger text-sm pull-right">{{$errors->first('application_id')}}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('next_followup')
                                            <span
                                                class="text-danger text-sm pull-right">{{$errors->first('next_followup')}}</span>
                                            @enderror
                                        </div>
                                    </div>
                    ...
                    <a href="{{route('admin.tasks.create')}}" class="btn btn-success ml-3">
                        Add Task
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row p-0">
                    <label for="cbx" style="font-weight: normal;padding-left: 1rem">
                         Showing {{$applications->count()}} tasks
                    </label>
                    <div class="col-md-12">

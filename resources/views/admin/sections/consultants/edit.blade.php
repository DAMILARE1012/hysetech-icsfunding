                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="gender" id="gender" class="form-control select2"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="male" {{old('gender',$consultant->gender)=='male'?'selected':''}}>
                                                        Male
                                                    </option>
                                                    <option
                                                        value="Female" {{old('gender',$consultant->gender)=='female'?'selected':''}}>
                                                        Female
                                                    </option>
                                                </select>
                                                @error('gender')
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="past_six_months_income"
                                                       ...
                                                       value="{{old('past_six_months_income',$consultant->past_six_monnths_income)}}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" id="active" name="active"
                                                       ...
                                                       value="1"
                                                    {{old('active',$consultant->active)==1?'checked="checked"':''}}>
                                            </div>
                                            <div class="form-group">
                                                <label for="image_input_field">Profile Photo</label><br>
                                                <img
                                                    id="image_preview"
                                                    src="{{asset($consultant->logo?'storage/'.$consultant->logo:'admin/dist/img/placeholder.png')}}"
                                                    style="width: 150px"
                                                    alt="">
                                                <br>
                                                <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control select2"
                                                    ...
                                                    @foreach($countries as $index=>$country)
                                                        <option
                                                            value="{{$country}}" {{old('country',$consultant->conutry) == $country ?'selected':''}}>{{$country}}</option>
                                                    @endforeach
                                                </select>
                                                @error('country')
                                                <span

                            ...
                            @foreach($permissions as $permission)
                                <div class="col-md-6">
                                    <label><input type="checkbox" name="permissions[]"
                                                  value="{{$permission->id}}" {{is_array(old('permissions',$role_permissions)) && in_array($permission->id,old('permissions',$role_permissions))?'checked="checked"':''}}> {{$permission->label}}
                                    </label>
                                </div>
                            @endforeach
                            <div class="col-md-12">

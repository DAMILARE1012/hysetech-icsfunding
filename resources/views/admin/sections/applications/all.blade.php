        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    {{--                    <a href="" class="pr-2" style="color: green;text-decoration: underline;font-weight: bold">View--}}
                    {{--                        Checker Module</a>--}}
                    <a href="{{route('admin.applications.create')}}" class="btn btn-success">Create Application</a>
                </div>
            </div>
            <div class="card-body">
                <form action="">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="status" id="status"
                                                                                ...
                                                                                @foreach($applicationStatuses as $index=>$applicationStatus)
                                                                                    <option
                                                                                        value="{{$applicationStatus->name}}" {{$applicationStatus->name == $application->status ?'selected':''}}>{{$applicationStatus->name}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                            @error('status')
                                                                            <span

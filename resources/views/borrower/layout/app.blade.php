    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #001733!important;">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <span style="color: white;font-size: 16px;font-weight: 300" class="nav-link pbt-2">{{$title}}</span>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                ...
                <span
                    style="color: white;font-size: 14px">{{auth('borrower')->user()->first_name}} {{auth('borrower')->user()->last_name}}</span>
            </li>
            <li class="nav-item pl-2">
                <form action="{{route('borrower.logout')}}" method="post">
                    @csrf
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{route('borrower.company')}}"
                           class="nav-link {{$nav_active == 'company'?'active':''}} pbt-2">
                            <span class="nav-icon">
                    ...
                    <li class="nav-item">
                        <a href="{{route('borrower.applications')}}"
                           class="nav-link {{$nav_active == 'applications'?'active':''}} pbt-2">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a href="{{route('borrower.loans')}}"
                           class="nav-link pbt-2 {{$nav_active == 'loans'?'active':''}}">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a href="{{route('borrower.notifications')}}"
                           class="nav-link pbt-2 {{$nav_active == 'notifications'?'active':''}}">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a href="{{route('borrower.administration')}}"

                                    ...
                                    <?php if($applications->count()): ?>
                                        <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    <a href="<?php echo e(route('consultant.tasks.repayments',$application)); ?>"
                                                       class="btn btn-default btn-sm">
                                                        Repayments History
                                                    </a>
                                                    <a href="<?php echo e(route('consultant.tasks.details',$application)); ?>"
                                                       class="btn btn-default btn-sm">
                                                        View detail
                                                    </a>
                                                    ...
                                                    <div class="modal" id="modal-status-<?php echo e($application->id); ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="<?php echo e(route('consultant.tasks.update-status', $application)); ?>"
                                                                    method="post">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('consultant.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/consultant/sections/tasks/index.blade.php ENDPATH**/ ?>
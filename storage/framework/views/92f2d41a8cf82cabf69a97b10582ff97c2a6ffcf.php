        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools pt-2">
                    <a data-toggle="modal" data-target="#modal-followup" class="btn btn-success ml-3">
                        Add Followup
                    </a>
                    <div class="modal" id="modal-followup">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form
                                    action="<?php echo e(route('admin.tasks.add-followup')); ?>"
                                    method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="application_id">Task</label>
                                            <select name="application_id" id="application_id"
                                                    class="form-control select2"
                                                    data-placeholder="Select Task" required>
                                                <option value=""></option>
                                                <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($application->id); ?>"><?php echo e($application->business->name); ?><?php echo e($application->activeLoan->loanType?' - '.$application->activeLoan->loanType->title:''); ?></option>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <span
                                                class="text-danger text-sm pull-right"><?php echo e($errors->first('application_id')); ?></span>
                                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" id="remarks" name="remarks"
                                                      placeholder="Enter Remarks" required><?php echo e(old('remarks')); ?></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <span
                                                class="text-danger text-sm pull-right"><?php echo e($errors->first('remarks')); ?></span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="next_followup">Next Followup Date</label>
                                            <input type="datetime-local" id="next_followup" name="next_followup"
                                                   class="form-control"
                                                   placeholder="Enter Next Followup Date">
                                            <?php $__errorArgs = ['next_followup'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            <span
                                                class="text-danger text-sm pull-right"><?php echo e($errors->first('next_followup')); ?></span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('admin.tasks.create')); ?>" class="btn btn-success ml-3">
                        Add Task
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row p-0">
                    <label for="cbx" style="font-weight: normal;padding-left: 1rem">
                         Showing <?php echo e($applications->count()); ?> tasks
                    </label>
                    <div class="col-md-12">
                                ...
                                <?php if($applications->count()): ?>
                                    <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo e($application->remarks); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/admin/sections/tasks/current.blade.php ENDPATH**/ ?>
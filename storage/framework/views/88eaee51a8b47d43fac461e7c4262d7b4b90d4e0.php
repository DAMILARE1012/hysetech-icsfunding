...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Radio Button -->
            <div class="form-group">
                <label class="block" for="">Select your role in the company</label>
                <br/>
                <div class="custom-control custom-radio custom-control-inline">
                    <input
                        type="radio"
                        id="director"
                        name="appointed_director"
                        class="custom-control-input"
                        value="1"
                        <?php echo e(old('appointed_director')==1?'checked':''); ?>


                    />
                    <label class="custom-control-label" for="director"
                    >Appointed director</label
                    >
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input
                        ...
                        name="appointed_director"
                        value="0"
                        <?php echo e(old('appointed_director',-1)==0?'checked':''); ?>

                        class="custom-control-input"
                    />
                    <label class="custom-control-label" for="non-director"
                    >Non- director</label
                    >
                </div>
                <?php $__errorArgs = ['appointed_director'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <br>
                <span class="text-danger text-sm pull-right"><?php echo e($errors->first('appointed_director')); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <span class="text-danger text-sm pull-right"><?php echo e($errors->first('password_confirmation')); ?></span>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            <div class="form-group">
                <div class="custom-control custom-switch">
                    <input
                        ...
                        id="ref_code"
                    />
                    <label class="custom-control-label" for="ref_code">
            ...
            <div class="form-group">
                ...
                <?php $__errorArgs = ['terms_consent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>

                <span class="text-danger text-sm pull-right"><?php echo e($errors->first('terms_consent')); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            ...
            <p>
                ...
                <a href="<?php echo e(route('borrower.login')); ?>" class="text-muted">Login</a>
            </p>
        </form>
    </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/auth/borrower/register.blade.php ENDPATH**/ ?>
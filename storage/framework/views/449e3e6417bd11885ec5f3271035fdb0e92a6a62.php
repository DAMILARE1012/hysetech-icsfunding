...
>
    <div class="position-relative d-flex flex-column justify-content-center">
        ...
        <form action="" method="post">
            ...
            <?php endif; ?>
            <h3>Member Login to ICS Funding</h3>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <a href="<?php echo e(route('consultant.forgot-password')); ?>" class="text-muted">Forgot Password?</a>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p>
                ...
                <a href="<?php echo e(route('consultant.register')); ?>" class="text-muted">Sign Up</a>
            </p>
        </form>
    </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/auth/consultant/login.blade.php ENDPATH**/ ?>
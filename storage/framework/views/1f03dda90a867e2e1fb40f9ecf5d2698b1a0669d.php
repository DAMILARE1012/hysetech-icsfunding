...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                ...
                <span
                    style="color: black;font-size: 14px"><?php echo e(auth('consultant')->user()->first_name); ?> <?php echo e(auth('consultant')->user()->last_name); ?></span>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="<?php echo e(route('consultant.profile')); ?>" class="brand-link" align="center">
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('consultant.profile')); ?>"
                           class="nav-link <?php echo e($nav_active == 'profile'?'active':''); ?> pbt-2">
                            <span class="nav-icon">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('consultant.tasks')); ?>"
                           class="nav-link <?php echo e($nav_active == 'tasks'?'active':''); ?> pbt-2">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('consultant.notifications')); ?>"
                           class="nav-link <?php echo e($nav_active == 'notifications'?'active':''); ?> pbt-2">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('consultant.settings')); ?>"
                           class="nav-link <?php echo e($nav_active == 'settings'?'active':''); ?> pbt-2">
                            <span class="nav-icon">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
...
<?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/consultant/layout/app.blade.php ENDPATH**/ ?>
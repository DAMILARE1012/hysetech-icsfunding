                            ...
                            <div class="form-group">
                                ...
                                <select name="business_id" id="business_id" class="form-control select2"
                                    ...
                                    <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$business): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($business->id); ?>" <?php echo e($business->id == old('business_id') ?'selected':''); ?>><?php echo e($business->name); ?></option>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span class="text-danger text-sm pull-right"><?php echo e($errors->first('business_id')); ?></span>
                                <?php unset($message);
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control select2"
                                    ...
                                    <?php $__currentLoopData = $applicationStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicationStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($applicationStatus->name); ?>" <?php echo e(old('status') == $applicationStatus->name? 'selected':''); ?>><?php echo e($applicationStatus->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <span class="text-danger text-sm pull-right"><?php echo e($errors->first('status')); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="verified" name="verified"
                                       ...
                                       value="1"
                                    <?php echo e(old('verified')==1?'checked="checked"':''); ?>>
                            </div>
    ...
    <script>
        $(function () {
            $('#loan_type_id').change(function () {
                $.getJSON('<?php echo e(url('admin/loan-types/loan-json')); ?>/' + $(this).val(), function (response) {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/admin/sections/applications/create.blade.php ENDPATH**/ ?>
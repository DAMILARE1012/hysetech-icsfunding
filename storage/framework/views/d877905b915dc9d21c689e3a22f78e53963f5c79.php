...
<!-- <link href="<?php echo e(asset('web')); ?>/vendor/icofont/icofont.min.css" rel="stylesheet" />
    ...
    />
    <link
        href="<?php echo e(asset('web')); ?>/vendor/owl.carousel/assets/owl.carousel.min.css"
        rel="stylesheet"
    />
...
<header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center">
        <a href="<?php echo e(route('web.index')); ?>" class="logo mr-auto">
            <img src="<?php echo e(asset('web')); ?>/img/logo.png" alt="" class="img-fluid"/>
        </a>
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="drop-down">
                    <a href="#">Login </a>
                    <ul>
                        <li><a href="<?php echo e(route('borrower.login')); ?>">User</a></li>
                        <li><a href="<?php echo e(route('consultant.login')); ?>">Consultant</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
    ...
    <div class="row mx-0">
        ...
        >
            <div class="footer-box box-2">
                <div class="logo">
                    <img src="<?php echo e(asset('web')); ?>/img/logo-2.png" class="fluid" alt=""/>
                </div>
                <p>
...
<?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/web/layout/app.blade.php ENDPATH**/ ?>
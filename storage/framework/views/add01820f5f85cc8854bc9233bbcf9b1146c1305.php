    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-edit"></i> Edit Borrower</h3>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="business_name" name="business_name"
                                                       class="form-control"
                                                       value="<?php echo e(old('business_name', $business->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="registration_type" name="registration_type"
                                                       class="form-control"
                                                       value="<?php echo e(old('registration_type', $business->registration_type)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="registration_number" name="registration_number"
                                                       class="form-control"
                                                       value="<?php echo e(old('registration_number', $business->registration_number)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="incorporation_type" id="incorporation_type"
                                                    ...
                                                    <option value=""></option>
                                                    <option
                                                        value="Private Limited Company" <?php echo e(old('incorporation_type',$business->incorporation_type) == 'Private Limited Company'?'selected':''); ?>>
                                                        Private Limited Company
                                                    </option>
                                                    <option
                                                        value="Public Limited Company" <?php echo e(old('incorporation_type',$business->incorporation_type) == 'Public Limited Company'?'selected':''); ?>>
                                                        Public Limited Company
                                                    </option>
                                                    <option
                                                        value="Public Company Limited by Guarantee" <?php echo e(old('incorporation_type',$business->incorporation_type) == 'Public Company Limited by Guarantee'?'selected':''); ?>>
                                                        Public Company Limited by Guarantee
                                                    </option>
                                                    <option
                                                        value="Sole Proprietorship" <?php echo e(old('incorporation_type',$business->incorporation_type) == 'Sole Proprietorship'?'selected':''); ?>>
                                                        Sole Proprietorship
                                                    </option>
                                                    <option
                                                        value="Partnership" <?php echo e(old('incorporation_type',$business->incorporation_type) == 'Partnership'?'selected':''); ?>>
                                                        Partnership
                                                    </option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="pincode" name="pincode" class="form-control"
                                                       value="<?php echo e(old('pincode',$business->pincode)); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" id="country" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($country); ?>" <?php echo e(old('country', $business->country) == $country ?'selected':''); ?>><?php echo e($country); ?></option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="loan_limit" name="loan_limit"
                                                       class="form-control"
                                                       value="<?php echo e(old('loan_limit',$business->loan_limit)); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                <span
                                                    class="text-danger text-sm pull-right"><?php echo e($errors->first('loan_limit')); ?></span>
                                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <select name="industry_id" id="industry_id" class="form-control select2"
                                                    ...
                                                    <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($industry->id); ?>" <?php echo e(old('industry_id', $business->industry_id) == $industry->id?'selected':''); ?>><?php echo e($industry->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="sub_industry_id" id="sub_industry_id"
                                                    ...
                                                    <?php $__currentLoopData = $subIndustries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subIndustry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($subIndustry->id); ?>" <?php echo e(old('sub_industry_id', $business->sub_industry_id) == $subIndustry->id?'selected':''); ?>><?php echo e($subIndustry->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="alternate_email" name="alternate_email"
                                                       class="form-control"
                                                       value="<?php echo e(old('alternate_email', $business->alternate_email)); ?>"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="office_phone" name="office_phone"
                                                       class="form-control"
                                                       value="<?php echo e(old('office_phone', $business->office_phone)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="hand_phone" name="hand_phone"
                                                       class="form-control"
                                                       value="<?php echo e(old('hand_phone', $business->hand_phone)); ?>"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="sms_phone" name="sms_phone"
                                                       class="form-control"
                                                       value="<?php echo e(old('sms_phone', $business->sms_phone)); ?>"
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/admin/sections/borrowers/edit.blade.php ENDPATH**/ ?>
                                ...
                                <?php if($reminders->count()): ?>
                                    <?php $__currentLoopData = $reminders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reminder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($reminder->reminder_type); ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if($reminder->attachment): ?>
                                                    <a href="<?php echo e(asset('storage/'.$reminder->attachment)); ?>"
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hysetech-icsfunding\resources\views/admin/sections/reminders/all.blade.php ENDPATH**/ ?>